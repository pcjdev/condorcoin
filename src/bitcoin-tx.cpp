...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s condorcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  condorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded condorcoin transaction") + "\n" +
              "  condorcoin-tx [options] -create [commands]   " + _("Create hex-encoded condorcoin transaction") + "\n" +
              "\n";
