...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.condorcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("condorcointools.com", "dnsseed.condorcointools.com"));
        vSeeds.push_back(CDNSSeedData("condorcoinpool.org", "dnsseed.condorcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("condorcointools.com", "testnet-seed.condorcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.condorcoin.loshan.co.uk", true));
