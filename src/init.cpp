...
void Shutdown()
{
    ...
    RenameThread("condorcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/condorcoin-project/condorcoin>";
    const std::string URL_WEBSITE = "<https://condorcoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("condorcoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Condorcoin version %s\n", FormatFullVersion());
}
